...
/***/ "./src/site/admin/containers/user/index.js":
/*!*************************************************!*\
  !*** ./src/site/admin/containers/user/index.js ***!
  \*************************************************/
/*! exports provided: default */
...
function index(props) {
      ...
      confirm({
        ...
        onOk() {
          _data_access_manufacturer_provider__WEBPACK_IMPORTED_MODULE_14__["default"].delete(item.id).then(s => {
            if (s && s.code === 0) {
              _utils_snackbar_utils__WEBPACK_IMPORTED_MODULE_15__["default"].show("Xóa tài khoản thành công", "success");
              onSearch(0, 10);
            } else {
              _utils_snackbar_utils__WEBPACK_IMPORTED_MODULE_15__["default"].show("Xóa tài khoản không thành công", "danger");
            }
          }).catch(e => {});
        },
  ...
  return __jsx(_admin_components_admin__WEBPACK_IMPORTED_MODULE_9__["AdminPage"], {
    ...
    header: "Qu\u1EA3n l\xFD t\xE0i kho\u1EA3n",
    subheader: "Danh s\xE1ch t\xE0i kho\u1EA3n"
  }, __jsx(_admin_components_admin__WEBPACK_IMPORTED_MODULE_9__["Panel"], {
    id: "panel-list-site",
    title: "DANH S\xC1CH T\xC0I KHO\u1EA2N",
    toolbar: __jsx("div", {
      className: "toolbar"
    ...
    columns: [{
      ...
      title: __jsx("div", {
        ...
        placeholder: "T\xECm theo m\xE3 t\xE0i kho\u1EA3n"
      })))),
      width: 200,
      dataIndex: "col2",
      key: "col2"
      ...
      title: __jsx("div", {
        ...
        placeholder: "T\xECm theo t\xEAn t\xE0i kho\u1EA3n"
      })))),
      width: 300,
      dataIndex: "col3",
      key: "col3"
