...
/***/ "./src/site/admin/containers/unit/index.js":
/*!*************************************************!*\
  !*** ./src/site/admin/containers/unit/index.js ***!
  \*************************************************/
/*! exports provided: default */
...
/* harmony import */ var _data_access_unit_provider__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @data-access/unit-provider */ "./src/data-access/unit-provider.js");
...
function index(props) {
  ...
  const onSearch = (action, item) => {
    ...
    _data_access_unit_provider__WEBPACK_IMPORTED_MODULE_14__["default"].search(page, size, ma, ten).then(s => {
      if (s.code == 0) {
        setState({
  ...
  const onDeleteItem = item => {
    return new _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_6___default.a((resolve, reject) => {
      confirm({
        ...
        onOk() {
          _data_access_unit_provider__WEBPACK_IMPORTED_MODULE_14__["default"].delete(item.id).then(s => {
            if (s && s.code === 0) {
              _utils_snackbar_utils__WEBPACK_IMPORTED_MODULE_15__["default"].show("Xóa đơn vị tính thành công", "success");
              onSearch(0, 10);
            } else {
              _utils_snackbar_utils__WEBPACK_IMPORTED_MODULE_15__["default"].show("Xóa đơn vị tính không thành công", "danger");
            }
          }).catch(e => {});
        },
  ...
  const create = () => {
    ...
    _data_access_unit_provider__WEBPACK_IMPORTED_MODULE_14__["default"].createOrEdit(dataIndex.id, ma, ten).then(s => {
      if (s && s.code === 0) {
        if (dataIndex.id) {
          _utils_snackbar_utils__WEBPACK_IMPORTED_MODULE_15__["default"].show("Cập nhật đơn vị tính thành công", "success");
        } else {
          _utils_snackbar_utils__WEBPACK_IMPORTED_MODULE_15__["default"].show("Thêm mới đơn vị tính thành công", "success");
        }
        ...
        if (dataIndex.id) {
          _utils_snackbar_utils__WEBPACK_IMPORTED_MODULE_15__["default"].show("Cập nhật đơn vị tính thất bại", "danger");
        } else {
          _utils_snackbar_utils__WEBPACK_IMPORTED_MODULE_15__["default"].show("Thêm mới đơn vị tính thất bại", "danger");
        }
      }
    }).catch(e => {});
  };
  ...
  return __jsx(_admin_components_admin__WEBPACK_IMPORTED_MODULE_9__["AdminPage"], {
    ...
    header: "Qu\u1EA3n l\xFD \u0111\u01A1n v\u1ECB t\xEDnh",
    subheader: "Danh s\xE1ch \u0111\u01A1n v\u1ECB t\xEDnh"
  }, __jsx("div", {
    className: "row"
  }, __jsx("div", {
    ...
    id: "panel-list-site",
    title: "DANH S\xC1CH \u0110\u01A0N V\u1ECA T\xCDNH" // toolbar={
    ...
    columns: [{
      ...
      title: __jsx("div", {
        ...
        className: "title-box"
      }, "M\xE3 \u0111\u01A1n v\u1ECB t\xEDnh"), __jsx("div", {
        className: "addition-box"
      }, __jsx("div", {
        ...
        placeholder: "T\xECm theo m\xE3 \u0111\u01A1n v\u1ECB t\xEDnh"
      })))),
      width: 200,
      dataIndex: "col2",
      key: "col2"
      ...
      title: __jsx("div", {
        ...
        className: "title-box"
      }, "T\xEAn \u0111\u01A1n v\u1ECB t\xEDnh"), __jsx("div", {
        className: "addition-box"
      }, __jsx("div", {
        className: "search-box"
      }, __jsx("img", {
        ...
        placeholder: "T\xECm theo t\xEAn \u0111\u01A1n v\u1ECB t\xEDnh"
      })))),
      width: 300,
      dataIndex: "col3",
      key: "col3"
    ...
    label: "M\xE3 \u0111\u01A1n v\u1ECB t\xEDnh"
  }, getFieldDecorator("dataIndex.ma", {
    rules: [{
      required: true,
      message: "Nhập mã đơn vị tính"
    }],
    ...
    placeholder: "Nh\u1EADp m\xE3 \u0111\u01A1n v\u1ECB t\xEDnh"
  }))))), __jsx("div", {
    className: "row"
  }, __jsx("div", {
    className: "col"
    ...
    placeholder: "Nh\u1EADp \u0111\u01A1n v\u1ECB t\xEDnh"
  }))))), __jsx("div", {
    style: {
      width: "100%",
