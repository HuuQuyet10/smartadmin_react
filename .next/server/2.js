...
/***/ "./src/site/admin/containers/device-type/index.js":
/*!********************************************************!*\
  !*** ./src/site/admin/containers/device-type/index.js ***!
  \********************************************************/
/*! exports provided: default */
...
/* harmony import */ var _data_access_device_type_provider__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @data-access/device-type-provider */ "./src/data-access/device-type-provider.js");
...
function index(props) {
  ...
  const onSearch = (action, item) => {
    ...
    _data_access_device_type_provider__WEBPACK_IMPORTED_MODULE_14__["default"].search(page, size, ma, ten).then(s => {
      if (s.code == 0) {
        setState({
  ...
  const onDeleteItem = item => {
    return new _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_6___default.a((resolve, reject) => {
      confirm({
        ...
        onOk() {
          _data_access_device_type_provider__WEBPACK_IMPORTED_MODULE_14__["default"].delete(item.id).then(s => {
            if (s && s.code === 0) {
              _utils_snackbar_utils__WEBPACK_IMPORTED_MODULE_15__["default"].show("Xóa loại thiết bị thành công", "success");
              onSearch(0, 10);
            } else {
              _utils_snackbar_utils__WEBPACK_IMPORTED_MODULE_15__["default"].show("Xóa loại thiết bị không thành công", "danger");
            }
          }).catch(e => {});
        },
  ...
  const onClose = () => {
    ...
    props.history.push("/admin/device-type");
  };
  ...
  const create = () => {
    ...
    _data_access_device_type_provider__WEBPACK_IMPORTED_MODULE_14__["default"].createOrEdit(dataIndex.id, ma, ten).then(s => {
      if (s && s.code === 0) {
        if (dataIndex.id) {
          _utils_snackbar_utils__WEBPACK_IMPORTED_MODULE_15__["default"].show("Cập nhật loại thiết bị thành công", "success");
        } else {
          _utils_snackbar_utils__WEBPACK_IMPORTED_MODULE_15__["default"].show("Thêm mới loại thiết bị thành công", "success");
        }
        ...
        if (dataIndex.id) {
          _utils_snackbar_utils__WEBPACK_IMPORTED_MODULE_15__["default"].show("Cập nhật loại thiết bị thất bại", "danger");
        } else {
          _utils_snackbar_utils__WEBPACK_IMPORTED_MODULE_15__["default"].show("Thêm mới loại thiết bị thất bại", "danger");
        }
      }
    }).catch(e => {});
  };
  ...
  return __jsx(_admin_components_admin__WEBPACK_IMPORTED_MODULE_9__["AdminPage"], {
    ...
    header: "Qu\u1EA3n l\xFD lo\u1EA1i thi\u1EBFt b\u1ECB",
    subheader: "Danh s\xE1ch lo\u1EA1i thi\u1EBFt b\u1ECB"
  }, __jsx("div", {
    className: "row"
  }, __jsx("div", {
    ...
    id: "panel-list-site",
    title: "DANH S\xC1CH LO\u1EA0I THI\u1EBET B\u1ECA" // toolbar={
    ...
    columns: [{
      ...
      title: __jsx("div", {
        ...
        placeholder: "T\xECm theo m\xE3 lo\u1EA1i thi\u1EBFt b\u1ECB"
      })))),
      width: 200,
      dataIndex: "col2",
      key: "col2"
      ...
      title: __jsx("div", {
        ...
        className: "title-box"
      }, "T\xEAn lo\u1EA1i thi\u1EBFt b\u1ECB"), __jsx("div", {
        className: "addition-box"
      }, __jsx("div", {
        className: "search-box"
      }, __jsx("img", {
        ...
        placeholder: "T\xECm theo t\xEAn lo\u1EA1i thi\u1EBFt b\u1ECB"
      })))),
      width: 300,
      dataIndex: "col3",
      key: "col3"
