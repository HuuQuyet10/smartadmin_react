...
/***/ "./src/site/admin/containers/manufacturer/index.js":
/*!*********************************************************!*\
  !*** ./src/site/admin/containers/manufacturer/index.js ***!
  \*********************************************************/
/*! exports provided: default */
...
function index(props) {
  ...
  const onSearch = (action, item) => {
    ...
    _data_access_manufacturer_provider__WEBPACK_IMPORTED_MODULE_14__["default"].search(page, size, ma, ten).then(s => {
      if (s.code == 0) {
        setState({
  ...
  const onDeleteItem = item => {
    return new _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_6___default.a((resolve, reject) => {
      confirm({
        ...
        onOk() {
          _data_access_manufacturer_provider__WEBPACK_IMPORTED_MODULE_14__["default"].delete(item.id).then(s => {
            if (s && s.code === 0) {
              _utils_snackbar_utils__WEBPACK_IMPORTED_MODULE_15__["default"].show("Xóa hãng sản xuất thành công", "success");
              onSearch(0, 10);
            } else {
              _utils_snackbar_utils__WEBPACK_IMPORTED_MODULE_15__["default"].show("Xóa hãng sản xuất không thành công", "danger");
            }
          }).catch(e => {});
        },
  ...
  const onClose = () => {
    ...
    props.history.push("/admin/manufacturer");
  };
  ...
  const create = () => {
    ...
    _data_access_manufacturer_provider__WEBPACK_IMPORTED_MODULE_14__["default"].createOrEdit(dataIndex.id, ma, ten).then(s => {
      if (s && s.code === 0) {
        if (dataIndex.id) {
          _utils_snackbar_utils__WEBPACK_IMPORTED_MODULE_15__["default"].show("Cập nhật hãng sản xuất thành công", "success");
        } else {
          _utils_snackbar_utils__WEBPACK_IMPORTED_MODULE_15__["default"].show("Thêm mới hãng sản xuất thành công", "success");
        }
        ...
        if (dataIndex.id) {
          _utils_snackbar_utils__WEBPACK_IMPORTED_MODULE_15__["default"].show("Cập nhật hãng sản xuất thất bại", "danger");
        } else {
          _utils_snackbar_utils__WEBPACK_IMPORTED_MODULE_15__["default"].show("Thêm mới hãng sản xuất thất bại", "danger");
        }
      }
    }).catch(e => {});
  };
  ...
  return __jsx(_admin_components_admin__WEBPACK_IMPORTED_MODULE_9__["AdminPage"], {
    ...
    header: "Qu\u1EA3n l\xFD h\xE3ng s\u1EA3n xu\u1EA5t",
    subheader: "Danh s\xE1ch h\xE3ng s\u1EA3n xu\u1EA5t"
  }, __jsx("div", {
    className: "row"
  }, __jsx("div", {
    ...
    id: "panel-list-site",
    title: "DANH S\xC1CH H\xC3NG S\u1EA2N XU\u1EA4T" // toolbar={
    ...
    columns: [{
      ...
      title: __jsx("div", {
        ...
        className: "title-box"
      }, "M\xE3 h\xE3ng s\u1EA3n xu\u1EA5t"), __jsx("div", {
        className: "addition-box"
      }, __jsx("div", {
        ...
        placeholder: "T\xECm theo m\xE3 h\xE3ng s\u1EA3n xu\u1EA5t"
      })))),
      width: 200,
      dataIndex: "col2",
      key: "col2"
      ...
      title: __jsx("div", {
        ...
        className: "title-box"
      }, "T\xEAn h\xE3ng s\u1EA3n xu\u1EA5t"), __jsx("div", {
        className: "addition-box"
      }, __jsx("div", {
        className: "search-box"
      }, __jsx("img", {
        ...
        placeholder: "T\xECm theo t\xEAn h\xE3ng s\u1EA3n xu\u1EA5t"
      })))),
      width: 300,
      dataIndex: "col3",
      key: "col3"
    ...
    placeholder: "Nh\u1EADp m\xE3 h\xE3ng s\u1EA3n xu\u1EA5t"
  }))))), __jsx("div", {
    className: "row"
  }, __jsx("div", {
    className: "col"
