...
/***/ "./src/site/admin/containers/manufacturer/create/index.js":
/*!****************************************************************!*\
  !*** ./src/site/admin/containers/manufacturer/create/index.js ***!
  \****************************************************************/
/*! exports provided: default */
...
function index(props) {
  ...
  const create = () => {
    _data_access_manufacturer_provider__WEBPACK_IMPORTED_MODULE_9__["default"].createOrEdit(id, state.ma, state.ten).then(s => {
      if (s && s.code === 0) {
        if (id) {
          _utils_snackbar_utils__WEBPACK_IMPORTED_MODULE_10__["default"].show("Cập nhật hãng sản xuất thành công", "success");
        } else {
          _utils_snackbar_utils__WEBPACK_IMPORTED_MODULE_10__["default"].show("Thêm mới hãng sản xuất thành công", "success");
        }

        props.history.push("/admin/hang-san-xuat");
      } else {
        if (id) {
          _utils_snackbar_utils__WEBPACK_IMPORTED_MODULE_10__["default"].show("Cập nhật hãng sản xuất thất bại", "danger");
        } else {
          _utils_snackbar_utils__WEBPACK_IMPORTED_MODULE_10__["default"].show("Thêm mới hãng sản xuất thất bại", "danger");
        }
      }
    }).catch(e => {});
  };
