    ...
    render() {
        return (
            <nav className="shortcut-menu d-none d-sm-block">
                ...
                <a href="/" onClick={this.disabledClick} className="menu-item btn" data-action="app-fullscreen" data-toggle="tooltip" data-placement="left" title="Full Screen">
                    <i className="fal fa-expand" />
                </a>
                <a href="/" onClick={this.disabledClick} className="menu-item btn" data-action="app-print" data-toggle="tooltip" data-placement="left" title="Print page">
                    <i className="fal fa-print" />
                </a>
                <a href="/" onClick={this.disabledClick} className="menu-item btn" data-action="app-voice" data-toggle="tooltip" data-placement="left" title="Voice command">
