            ...
            <aside className="page-sidebar">
                ...
                <nav id="js-primary-nav" className="primary-nav" role="navigation">
                    ...
                    <ul id="js-nav-menu" className="nav-menu">
                        <li>
                            ...
                            <ul>
                                <li>
                                    <Link to="/intel_analytics_dashboard" title="Analytics Dashboard" data-filter-tags="application intel analytics dashboard">
                                        <span className="nav-link-text" data-i18n="nav.application_intel_analytics_dashboard">Analytics Dashboard</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link to="/intel_marketing_dashboard" title="Marketing Dashboard" data-filter-tags="application intel marketing dashboard">
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="fake_url;" title="Menu child" data-filter-tags="utilities menu child">
                                        <span className="nav-link-text" data-i18n="nav.utilities_menu_child">Menu child</span>
                                    </a>
                                    <ul>
                                        <li>
                                            <a href="fake_url;" title="Sublevel Item" data-filter-tags="utilities menu child sublevel item">
                                                <span className="nav-link-text" data-i18n="nav.utilities_menu_child_sublevel_item">Sublevel Item</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="fake_url;" title="Another Item" data-filter-tags="utilities menu child another item">
                                ...
                                <li className="disabled">
                                    <a href="fake_url;" title="Disabled item" data-filter-tags="utilities disabled item">
                        ...
                        <li>
                            ...
                            <ul>
                                <li>
                                    <a href="fake_url;" title="FontAwesome" data-filter-tags="font icons fontawesome">
                                ...
                                <li>
                                    <a href="fake_url;" title="NextGen Icons" data-filter-tags="font icons nextgen icons">
                                ...
                                <li>
                                    <a href="fake_url;" title="Stack Icons" data-filter-tags="font icons stack icons">
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="fake_url;" title="Forum" data-filter-tags="pages forum">
                                ...
                                <li>
                                    <a href="fake_url;" title="Inbox" data-filter-tags="pages inbox">
                                ...
                                <li>
                                    <a href="fake_url;" title="Authentication" data-filter-tags="pages authentication">
                                ...
                                <li>
                                    <a href="fake_url;" title="Error Pages" data-filter-tags="pages error pages">
                ...
                <div className="nav-footer shadow-top">
                    ...
                    <ul className="list-table m-auto nav-footer-buttons">
                        <li>
                            <a href="fake_url;" data-toggle="tooltip" data-placement="top" title="Chat logs">
                                <i className="fal fa-comments" />
                            </a>
                        </li>
                        <li>
                            <a href="fake_url;" data-toggle="tooltip" data-placement="top" title="Support Chat">
                                <i className="fal fa-life-ring" />
                            </a>
                        </li>
                        <li>
                            <a href="fake_url;" data-toggle="tooltip" data-placement="top" title="Make a call">
