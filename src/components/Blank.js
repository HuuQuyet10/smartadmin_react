            ...
            <div>
                <div>
                    <ol className="breadcrumb page-breadcrumb">
                        <li className="breadcrumb-item"><a href="/">SmartAdmin</a></li>
                    ...
                    <div className="subheader">
                        <h1 className="subheader-title">
                            <i className="subheader-icon fal fa-" /> Page <span className="fw-300">Title</span> <sup className="badge badge-primary fw-500">ADDON</sup>
                            <small>
                                blank description
                            </small>
                        </h1>
